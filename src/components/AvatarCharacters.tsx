...
const animations: Variants = {
  idle: { scale: 1, y: 0, rotate: 0, scaleY: 1 },
  breathing: {
    scale: [1, 1.03, 1],
...
export const BunnyCharacter = ({ size, color = "#0D0D0D", accentColor = "#FFB8B8", eyeColor = "#FFFFFF" }: CharacterProps) => (
  <CharacterWrapper size={size}>
    <motion.g animate="breathing">
      {/* Ears */}
      <motion.path d="M35 30Q30 10 40 15L45 35" fill={color} animate="earTwitch" style={{ originX: "40%", originY: "35%" }} />
      <motion.path d="M65 30Q70 10 60 15L55 35" fill={color} animate="earTwitch" style={{ originX: "60%", originY: "35%" }} />
      {/* Inner Ears */}
      ...
      {/* Eyes */}
      <motion.g animate="blinking" style={{ originX: "50%", originY: "55%" }}>
...
export const PandaCharacter = ({ size, color = "#0D0D0D", accentColor = "#FFFFFF", eyeColor = "#FFFFFF" }: CharacterProps) => (
  <CharacterWrapper size={size}>
    <motion.g animate="bouncing">
      ...
      {/* Eyes */}
      <motion.g animate="blinking" style={{ originX: "50%", originY: "58%" }}>
...
export const FoxCharacter = ({ size, color = "#0D0D0D", accentColor = "#FFFFFF", eyeColor = "#FFFFFF" }: CharacterProps) => (
  <CharacterWrapper size={size}>
    <motion.g animate="breathing">
      ...
      {/* Eyes */}
      <motion.g animate="blinking" style={{ originX: "50%", originY: "50%" }}>
...
export const FrogCharacter = ({ size, color = "#0D0D0D", accentColor = "#FFFFFF", eyeColor = "#E8FF47" }: CharacterProps) => (
  <CharacterWrapper size={size}>
    <motion.g animate="bouncing">
      ...
      {/* Eyes */}
      <motion.g animate="blinking" style={{ originX: "50%", originY: "40%" }}>
...
export const GhostCharacter = ({ size, color = "#0D0D0D", accentColor = "#FFFFFF", eyeColor = "#FFFFFF" }: CharacterProps) => (
  <CharacterWrapper size={size}>
    <motion.g animate="bouncing">
      ...
      <motion.g animate="blinking" style={{ originX: "50%", originY: "48%" }}>
...
export const AlienCharacter = ({ size, color = "#0D0D0D", accentColor = "#FFFFFF", eyeColor = "#FFFFFF" }: CharacterProps) => (
  <CharacterWrapper size={size}>
    <motion.g animate="breathing">
      ...
      <motion.g animate="blinking" style={{ originX: "50%", originY: "45%" }}>
